...
import { ArrowRight, EyeIcon, EyeOffIcon, Github, Loader2 } from "lucide-react"
...
export default function Login() {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      ...
      <Card className="w-full max-w-md shadow-xl border-0 dark:bg-slate-900/60 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" onClick={() => handleSocialLogin("google")} disabled={isLoading} className="h-11">
            ...
            <Button variant="outline" onClick={() => handleSocialLogin("github")} disabled={isLoading} className="h-11">
